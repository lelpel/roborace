            ...
            , methods = {
                init: function (opt) {
                    this.each(function () {
                            ...
                            $spanLeft = $('<span></span>').addClass("labelLeft").text(options.label.enabled === undefined ? options.on_text : options.label.enabled);
                            $spanRight = $('<span></span>').addClass("labelRight").text(options.label.disabled === undefined ? options.off_text : options.label.disabled);
