...
<?php if (have_posts()) : ?>
    <h1>
        <?php if (is_day()) : ?>
            <?php printf(__('Daily Archives:', CURRENT_THEME) . "%s", '<span>' . get_the_date() . '</span>'); ?>
        <?php elseif (is_month()) : ?>
            <?php printf(__('Monthly Archives:', CURRENT_THEME) . "%s", '<span>' . get_the_date('F Y') . '</span>'); ?>
        <?php
        elseif (is_year()) : ?>
            <?php printf(__('Yearly Archives:', CURRENT_THEME) . "%s", '<span>' . get_the_date('Y') . '</span>'); ?>
        <?php
        else : ?>
